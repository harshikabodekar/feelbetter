  ...
  return (
    <main style={{
      ...
      <div style={{
        ...
        {/* LEFT — brand side */}
        <div style={{
          flex: window.innerWidth < 768 ? '1' : '1.1',
          display: 'flex',
          flexDirection: 'column',
          justifyContent: 'center',
          padding: 'clamp(30px, 8vw, 60px) clamp(25px, 7vw, 50px)',
          borderRight: window.innerWidth < 768 ? 'none' : '1px solid rgba(168, 230, 232, 0.15)',
          borderBottom: window.innerWidth < 768 ? '1px solid rgba(168, 230, 232, 0.15)' : 'none',
          position: 'relative',
        }}>

          {/* logo */}
          <div style={{ marginBottom: '40px', textAlign: 'left' }}>
            <div style={{ fontSize: '2rem', marginBottom: '12px', letterSpacing: '0.3em' }}>
              𓆝 𓆟 𓆞 𓆝 𓆟
            </div>
            <h2 style={{
              color: '#e8f8f9', fontSize: '3rem', fontWeight: '700',
        ...
        <div style={{
          ...
          <div style={{ width: '100%' }}>
            ...
            {error && (
              <div style={{
                color: '#ff8a8a', marginBottom: '1rem', fontSize: '0.9rem',
            ...
            <div style={{
              ...
              <span style={{ color: 'rgba(232,248,249,0.4)', fontSize: '0.8rem', letterSpacing: '0.1em' }}>OR</span>
              <div style={{ flex: 1, height: '1px', background: 'rgba(168,230,232,0.2)' }} />
            </div>
          ...
          <p style={{
            ...
            fontSize: '2 rem', margin: '20px 0 0',
          }}>
