      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', marginBottom: '40px' }}>
            ...
            <h2 style={{
              color: '#e8f8f9', fontSize: '1.6rem', fontWeight: '700',
        ...
        <div style={{
          ...
          <div style={{ width: '100%' }}>
            ...
            <button onClick={handleSubmit} style={{
              ...
              borderRadius: '12px', fontSize: '1.25rem', fontWeight: '700',
            ...
            <button style={{
              ...
              borderRadius: '12px', fontSize: '2rem', fontWeight: '600',
