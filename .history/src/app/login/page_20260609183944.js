        ...
        <div style={{
          ...
          <div style={{ width: '100%' }}>
            ...
            <button onClick={handleSubmit} style={{
              ...
              borderRadius: 'clamp(8px, 3vw, 12px)', fontSize: 'clamp(0.9rem, 3vw, 1rem)', fontWeight: '700',
            ...
            <button style={{
              ...
              borderRadius: 'clamp(8px, 3vw, 12px)', fontSize: 'clamp(0.85rem, 3vw, 1rem)', fontWeight: '600',
