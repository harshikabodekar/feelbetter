...
export default function Dashboard() {
  ...
  // desktop blob positions (absolute positioning within the right column)
  const blobPositions = {
    empty:       { top: "8%", left: "5%", width: "140px", height: "110px" },
    overwhelmed: { top: "2%", right: "8%", width: "160px", height: "105px" },
    okayish:     { top: "35%", left: "50%", transform: "translateX(-50%)", width: "220px", height: "95px" },
    heavy:       { bottom: "15%", left: "0%", width: "150px", height: "115px" },
    full:        { bottom: "8%", right: "2%", width: "155px", height: "110px" },
  }
    ...
    <>
      <style>{`
        * {
        ...
        /* tablet and up: absolute positioning */
        @media (min-width: 768px) {
          .fb-mood-btn {
            position: absolute;
            border-radius: 50%;
      ...
      <div className="fb-root">
        ...
        <div className="fb-main">
          ...
          <div className="fb-checkin-card">
            ...
            {/* right column: mood blobs */}
            <div className="fb-moods-wrapper">
              <div className="fb-moods-grid">
                {MOODS.map((mood) => {
                  const style = isDesktop ? blobPositions[mood.id] : {}
                  return (
                    <button
                      key={mood.id}
