          ...
          {moods.map(mood => (
            <button
              ...
              style={{
                ...
                background: selectedMood === mood ? 'rgba(14, 143, 163, 0.2)' : 'rgba(255, 255, 255, 0.4)',
                color: '#0e8fa3',
                boxShadow: selectedMood === mood ? '0 4px 12px rgba(14, 143, 163, 0.3)' : 'none',
              }}
              onMouseEnter={e => {
                e.target.style.borderColor = '#0e8fa3'
                e.target.style.background = 'rgba(14, 143, 163, 0.15)'
              }}
              onMouseLeave={e => {
